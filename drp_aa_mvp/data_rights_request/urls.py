...
urlpatterns = [
    ...
    #path('send_request_discover_data_rights', views.send_request_discover_data_rights, name='send_request_discover_data_rights'),

    path('send_request_excercise_rights', views.send_request_excercise_rights, name='send_request_excercise_rights'),
